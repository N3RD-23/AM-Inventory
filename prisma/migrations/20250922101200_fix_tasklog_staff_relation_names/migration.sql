/*
  ...
  - You are about to drop the column `updatedAt` on the `TaskLog` table. All the data in the column will be lost.
...
INSERT INTO "new_Staff" ("departmentId", "designationId", "firstName", "id", "lastName", "staffCode") SELECT "departmentId", "designationId", "firstName", "id", "lastName", "staffCode" FROM "Staff";
DROP TABLE "Staff";
