...
export default function RackPage() {
    const racks = [
        ...
        "RACK - Luna",
        "RACK - Grill Kitchen",
        "RACK - GRILL Beach Bar",
        "RACK - Main Store",
        "RACK - General Store",
        "RACK - Staff Service",
        "RACK - 2nd Island Clinic",
        "RACK - Staff Accomodation 1st Floor",
        "RACK - Staff Accomodation 2nd Floor",
        "RACK - Engineering",
        "RACK - Security",
        "RACK - Power House",
        "RACK - 2nd Island HOD Accomodation",
    ];
    ...
    return (
        <div className="p-4 space-y-6">
            <div className="flex items-center gap-2">
                <Wifi size={24} />
                <h1 className="text-2xl font-semibold">Server Racks</h1>
            </div>
